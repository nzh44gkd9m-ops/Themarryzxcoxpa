...
def main_menu():
    return InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton(text="💬 Написать", callback_data="chat")],
        [InlineKeyboardButton(text="❤️ Мы", callback_data="about")],
...
async def about(call: types.CallbackQuery):
    ...
    if pair:
        ...
        text = (
            f"❤️ Вы вместе: {days} дней\n"
            f"💞 Твой уровень: {level}\n"
            f"✨ XP: {xp}"
        )
    else:
        text = "Вы ещё не подключили пару 😢"
